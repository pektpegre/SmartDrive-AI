...
Στη συνέχεια κατανόησαν τη λειτουργία της κάμερας HuskyLens και έμαθαν πώς μπορούν να την εκπαιδεύουν, ώστε να αναγνωρίζει χρώματα, αντικείμενα και ετικέτες ή να ακολουθεί ένα συγκεκριμένο αντικείμενο. Εξοικειώθηκαν με την οθόνη και το μενού λειτουργίας της και έκαναν πολλές δοκιμές προκειμένου να την κατανοήσουν και να μάθουν να την εκπαιδεύουν.

Στο επόμενο στάδιο έπρεπε η κάμερα να συνδεθεί με το micro:bit και να εξοικειωθούν οι μαθητές με το προγραμματιστικό περιβάλλον και τον έλεγχο της κάμερας μέσω του μικροελεγκτή.
